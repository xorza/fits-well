...
| §7.3 | Binary tables | Partial: all fixed kinds and P/Q reads exist, character/null fields are lossless, empty VLA cells obey `TDIM`, and numeric/complex/exact-unsigned/bit VLA views exist; `PX`/`QX` writing remains absent. |
